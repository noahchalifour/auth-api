...
from auth.api_client import ApiClient, Endpoint as _Endpoint
from auth.model_utils import (  # noqa: F401
...
class ClientsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.destroy_client_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [],
                'endpoint_path': '/clients/{id}/',
                'operation_id': 'destroy_client',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
        ...
        self.partial_update_client_endpoint = _Endpoint(
            settings={
                'response_type': (Client,),
                'auth': [],
                'endpoint_path': '/clients/{id}/',
        ...
        self.retrieve_client_endpoint = _Endpoint(
            settings={
                'response_type': (Client,),
                'auth': [],
                'endpoint_path': '/clients/{id}/',
    ...
    def create_client(
        ...
        **kwargs
        ...
        Keyword Args:
            create_client (CreateClient): [optional]
    ...
    def destroy_client(
        ...
        **kwargs
        ...
        """destroy_client  # noqa: E501

          # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.destroy_client(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['id'] = \
            id
        return self.destroy_client_endpoint.call_with_http_info(**kwargs)
    ...
    def partial_update_client(
        ...
        **kwargs
        ...
        """partial_update_client  # noqa: E501

          # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.partial_update_client(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['id'] = \
            id
        return self.partial_update_client_endpoint.call_with_http_info(**kwargs)
    ...
    def retrieve_client(
        ...
        **kwargs
        ...
        """retrieve_client  # noqa: E501

          # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.retrieve_client(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['id'] = \
            id
        return self.retrieve_client_endpoint.call_with_http_info(**kwargs)
