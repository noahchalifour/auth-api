...
from auth import rest
from auth.configuration import Configuration
from auth.exceptions import ApiTypeError, ApiValueError, ApiException
from auth.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = AuthorizeApi()
        api_instance.create_authorize  # this is an instance of the class Endpoint
        api_instance.create_authorize()  # this invokes api_instance.create_authorize.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.create_authorize.callable or self.callable in this class
